...
# API and commit. NOTE: this app commits with changes sent for review automatically
# (no draft mode), so committing submits the listing for review. No secrets here.
#
...
echo "committing (sent for review automatically)..."
