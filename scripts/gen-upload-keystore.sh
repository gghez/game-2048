...
#
# Env (optional):
#   KEYSTORE_FILE  - target .jks path (default: $HOME/keystores/game2048-upload.jks)
#   KEYSTORE_ALIAS - key alias (default: game2048)
#   DNAME          - certificate DN (default: CN=gghez, O=gghez, C=FR)
set -euo pipefail
ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
KS="${KEYSTORE_FILE:-$HOME/keystores/game2048-upload.jks}"
ALIAS="${KEYSTORE_ALIAS:-game2048}"
...
# 2exp11 UPLOAD keystore credentials — NEVER commit or share. Back up the .jks securely.
